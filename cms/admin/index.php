                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            $element_text = ['Active Posts','Draft Posts', 'Comments', 'Pending Comments', 'Users', 'Users Subscriber', 'Categories'];
                            $element_count = [$post_counts, $post_draft_counts , $comment_counts, $unapproved_comments_counts , $user_counts, $subscriber_counts, $cat_counts];
